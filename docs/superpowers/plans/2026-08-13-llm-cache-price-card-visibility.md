...
- [x] **Step 1: Write failing fixed-price layout tests**
...
- [x] **Step 2: Verify the fixed-price tests fail**
...
- [x] **Step 3: Promote fixed cached input to the primary grid**
...
- [x] **Step 4: Verify fixed-price tests pass**

Run the command from Step 2 and expect the fixed cases to pass.

- [x] **Step 5: Write the failing dynamic-price layout test**
...
- [x] **Step 6: Verify the dynamic-price test fails**

Run the command from Step 2 and expect the cache-read primary assertion to fail.

- [x] **Step 7: Promote dynamic cache read locally**
...
- [x] **Step 9: Verify local UI and commit**
