...
export const STATIC_I18N_KEYS = [
  ...
  'Single-request input {{range}} Tokens',
  'Base-period price',
  'Default price',
  ...
  // Product quotation runtime labels and validation messages
  'Input',
  'Output',
  'Cache read',
  'Cache write',
  ...
  'Global discount must be greater than 0 and at most 10.',
  'The selected price basis has no valid ratio.',
  'Provider discount must be greater than 0 and at most 10.',
  ...
  'Expected an array of group display metadata',
  'Drag to reorder group',
  'Move group up',
  'Move group down',
  'Recommended {{count}}/5',
  'Group success rates',
  'Group success rates for {{period}}',
  'Group success rates are temporarily unavailable',
  'Group success rate ranking',
  'Successful requests by configured group over {{period}}',
  'Other rankings are still available',
  ...
  'Select {{group}}',
  'No groups selected',
  'One group uses fixed routing',
  '{{count}} groups will be tried in order',
  'Use system default order',
  ...
  'Unable to load video generation options',
  'Refresh the page and try again.',
  'No compatible API key',
  ...
  'Add URL',
  'Public URL',
  'Add reference media for this generation',
  'Text mode does not include reference media.',
  'Frame mode only accepts images',
  'The selected file exceeds the upload limit',
  'Enter a valid public HTTP or HTTPS URL',
  'File uploaded and added to this request',
  'Frame role',
  'First frame',
  'Last frame',
  'Remove media',
  ...
  'Video preview',
  'The latest submitted or selected task appears here.',
  'Loading generation task...',
  'No video selected',
  'Submit a task or choose Preview from generation history.',
  'Generating video',
  ...
  'Failed to submit video generation task',
  'Enter a prompt for text-to-video generation',
  'Wait for selected assets to become available or replace them.',
  'A selected temporary asset is not ready or has expired.',
  'Frame mode requires exactly one first-frame image.',
  ...
  'Too many reference videos for this model.',
  'Too many reference audio files for this model.',
  'Invalid media selection.',
  'Loading generation history...',
  'No Seedance generations yet',
  'Seedance video',
  'Parameters',
  'Input media',
  'Elapsed time',
