...
import { MoliiAigcPricingTabs } from './molii-aigc-pricing-tabs'
import { MoliiGrokPricingSection } from './molii-grok-pricing-section'
...
const getGroupDefaults = (settings: BillingSettings) => ({
  ...
  GroupMetadata: settings['group_ratio_setting.group_metadata'],
