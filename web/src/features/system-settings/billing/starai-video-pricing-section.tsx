...
const fields: Array<{ name: FieldName; label: string; description: string }> = [
  {
    name: 'standard_720p',
    label: 'Seedance 2.0 · 720p · Text/Image',
    description: 'No reference video input',
  },
  {
    name: 'standard_720p_video',
    label: 'Seedance 2.0 · 720p · Video',
    description: 'Contains reference video input',
  },
  {
    name: 'standard_1080p',
    label: 'Seedance 2.0 · 1080p · Text/Image',
    description: 'No reference video input',
  },
  {
    name: 'standard_1080p_video',
    label: 'Seedance 2.0 · 1080p · Video',
    description: 'Contains reference video input',
  },
  {
    name: 'standard_4k',
    label: 'Seedance 2.0 · 4K · Text/Image',
    description: 'No reference video input',
  },
  {
    name: 'standard_4k_video',
    label: 'Seedance 2.0 · 4K · Video',
    description: 'Contains reference video input',
  },
  {
    name: 'fast_720p',
    label: 'Seedance 2.0 Fast · 720p · Text/Image',
    description: 'No reference video input',
  },
  {
...
export function StarAIVideoPricingSection({
  defaultValues,
}: {
    ...
    <SettingsSection title={t('Molii AIGC Video Pricing')}>
      ...
      <Form {...form}>
        <SettingsForm onSubmit={handleSubmit}>
          ...
          <FormDescription>
            {t(
              'Direct platform price per 1M tokens. CNY and USD are treated as 1:1; no exchange-rate conversion is applied.'
            )}
          </FormDescription>
          <SettingsFormGrid>
            {fields.map((item) => (
