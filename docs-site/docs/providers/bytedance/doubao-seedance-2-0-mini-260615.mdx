---
title: "Doubao Seedance 2.0 Mini"
sidebar_position: 36
---

# Doubao Seedance 2.0 Mini

面向高性价比视频生成场景的 Seedance 2.0 Mini，支持文本、图片、视频和音频参考，输出 480p/720p 视频。

- **模型 ID：** `doubao-seedance-2-0-mini-260615`
- **Provider：** ByteDance
- **输入模态：** text、image、video、audio
- **输出模态：** video
- **英文简介：** A cost-efficient Seedance 2.0 video generation model supporting text\, image\, video\, and audio references with 480p and 720p output.
- **发布日期：** 2026-06-15
- **最大输入图片数：** 9
- **视频时长范围：** 4–15 秒
- **支持分辨率：** 480p、720p
...
curl --fail-with-body --silent --show-error \
  ...
  --data '{"model":"doubao-seedance-2-0-mini-260615","content":[{"type":"text","text":"镜头缓慢向前推进，晨雾从山谷间流过"},{"type":"image_url","image_url":{"url":"https://example.invalid/first-frame.jpg"},"role":"first_frame"}],"generate_audio":true,"resolution":"720p","ratio":"16:9","duration":5,"watermark":false}'
```
