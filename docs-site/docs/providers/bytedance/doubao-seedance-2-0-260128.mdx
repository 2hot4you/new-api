...
curl --fail-with-body --silent --show-error \
  ...
  --data '{"model":"doubao-seedance-2-0-260128","content":[{"type":"text","text":"镜头缓慢向前推进，晨雾从山谷间流过"},{"type":"image_url","image_url":{"url":"https://example.invalid/first-frame.jpg"},"role":"first_frame"}],"generate_audio":true,"resolution":"720p","ratio":"16:9","duration":5,"watermark":false}'
```
